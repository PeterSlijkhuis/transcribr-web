...
Exports CSV, JSON, SRT and DOCX. The CSV/JSON schema
...
The first file you add downloads about 275 MB of engines and models from
Hugging Face (URLs in `engines/manifest.json`); the browser caches them.
